...
$sql = "SELECT a.* , a.id as id, NamaBidang as unit_kerja
		...
		ORDER BY tgl_permohonan DESC LIMIT 150";
$pdo->query($sql);
...
$html = '
	...
	<div class="filters">
	    <div class="filter-container">
	        <b style="color:#516395">&nbsp;&nbsp;Filter&nbsp;&nbsp;</b>
			<input autocomplete="off" class="filter" name="Perihal" placeholder="Perihal" data-col="Perihal" />
			<input autocomplete="off" class="filter" name="Status" placeholder="Status" data-col="Status" />
			<input autocomplete="off" class="filter" name="Unit Kerja" placeholder="Unit Kerja" data-col="Unit Kerja" />
	    </div>
	</div>
	<br>
