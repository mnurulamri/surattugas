...
$sql = "SELECT a.* , NamaBidang as unit_kerja
		...
		(
			SELECT KodeBidang
			FROM pejabat
			WHERE user_pemohon = '$username' AND CURDATE() BETWEEN start_date AND end_date
		) ";*/

$sql = "SELECT a.* , NamaBidang as unit_kerja
		FROM surtu_kegiatan a
		JOIN TblBidangDetail b ON a.KodeBidang = b.KodeBidang AND a.KodeBidang AND user_pemohon = '$username' ORDER BY a.id DESC";
$pdo->query($sql);
	...
	<fieldset>
		...
		<div class="filters">
			<div class="filter-container">
				<input autocomplete="off" class="filter" name="Nama Kegiatan" placeholder="Nama Kegiatan" data-col="Nama Kegiatan" />
				<input autocomplete="off" class="filter" name="Tgl. Permohonan" placeholder="Tgl. Permohonan" data-col="Tgl. Permohonan" />
